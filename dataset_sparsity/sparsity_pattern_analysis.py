...
def collect_sparse(args):
  ...
  models_str = ''
  capital_names = {'resnet': 'ResNet-50', 'vgg': 'VGG-16', 'googlenet': 'GoogleNet', 'mobilenetv1': 'MobileNet'}
  for k in range(len(args.model_names)):
    ...
    ax.set_xlabel('Normalized MAC Operation (' + capital_names[model_name] +')', fontsize=plt_fontsize)

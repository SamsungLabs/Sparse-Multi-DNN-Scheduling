...
def collect_sparse(args):
  ...
  fig.savefig(args.figs_path + args.model_name + "_intra_network_sparsity_quant.png")
  plt.close()
  ...
  plt.xlabel('Cross_Data_Sparsity_Quant')
  plt.savefig(args.figs_path + args.model_name + "_inter_network_sparsity_quant.png")
  ...
  for i in range(len(intern_hooks)):
    ...
    plt.ylabel('Probability')
    plt.xlabel('Layer_Sparsity_Quant')
    # plt.show()  
  plt.savefig(args.figs_path + args.model_name + "_layer_sparsity_quant.png")
